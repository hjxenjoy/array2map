...
export function array2item<T extends { [x: string]: any }, K = string | number, R = any>(array: T[], getKey: (item: T, index: number) => K, getValue: (item: T, index: number) => R): Record<string, R>
